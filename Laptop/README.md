...
The core logic resides in the `Laptop/firmware/twist_subscriber/` directory.
...
* **$v$**: Linear velocity ($x$) from `cmd_vel`.
* **$w$**: Angular velocity ($z$) from `cmd_vel`.
...
> **Note:** This project is part of the Senior Capstone at the **University of Houston–Clear Lake**, developed at the **Center for Robotics Software**.
